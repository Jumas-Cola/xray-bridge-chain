...
echo "Bridge:"
echo "vless://$BRIDGE_UUID@$BRIDGE_IP:$BRIDGE_PORT?encryption=none&security=reality&sni=ya.ru&fp=chrome&pbk=$BRIDGE_PUBLIC&sid=$BRIDGE_SHORT_ID&type=xhttp&path=%2Fcdn%2Fassets%2Fmain.min.js#Bridge-Reality"
echo ""
